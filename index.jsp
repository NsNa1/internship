			...
			<nav>
				<ul id="menu">
					...
					<li><a href="UploadLogin.jsp"><span>U</span>pload</a></li>
                                        <li><a href="contact.jsp"><span>C</span>ontacts</a></li>
                                        <li><a href="image.jsp"><span>G</span>raph</a></li>
				</ul>
			</nav>
		</div>
						...
						<div class="wrapper pad_top1">
							<div class="col3">
								<div class="wrapper">
									...
									<p class="cols"><strong class="font1">Development</strong><br>The Java Development Kit (JDK) is an implementation of either one of the Java SE, Java EE or Java ME platforms[1] released by Oracle Corporation in the form of a binary product aimed at Java developers on Solaris, Linux, Mac OS X or Windows. .</p>
								</div>
							</div>
							<div class="col3 pad_left2">
								<div class="wrapper">
									<figure class="left marg_right1"><img src="images/page1_img5.png" alt=""></figure>
									<p class="cols"><strong class="font1">Creative Design</strong><br>JavaServer Pages (JSP) is a technology that helps software developers create dynamically generated web pages based on HTML, XML, or other document types...</p>
								</div>
							</div>
						</div>
						<div class="wrapper">
							<div class="col3">
								<div class="wrapper">
									...
									<div class="cols"><strong class="font1">Planning</strong><br>In Strategy pattern, a class behavior or its algorithm can be changed at run time. This type of design pattern comes under behavior pattern..</div>
								</div>
							</div>
							<div class="col3 pad_left2">
								<div class="wrapper">
...
<!-- footer -->
	<footer>
		...
		<a href="index.jsp" class="footer_logo">nsna<span>___</span>.com</a>
	</footer>
<!-- / footer -->
</div>
