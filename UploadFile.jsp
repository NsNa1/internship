		...
		<div class="wrapper">
			...
			<div>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <h2><span><input type="file" name="file" id="file" /></span></h2>
			...
			<div>				
				...
				<h2><span><button type="submit" id="login">Submit</button></span></h2>
                  </form>
...
<!-- footer -->
	<footer>
		...
		<a href="index.html" class="footer_logo">nsna<span>___</span>.com</a>
	</footer>
<!-- / footer -->
</div>
